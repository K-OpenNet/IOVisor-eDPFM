...
class NetworkIpPacketPoint:
    ...
    def _store_packet_ip_info(self, packet_bytearray, packet_info):
        ...
        packet_info["ether_src_addr"] = "{:x}.{:x}.{:x}.{:x}.{:x}.{:x}".format(packet_bytearray[0],packet_bytearray[1],packet_bytearray[2],packet_bytearray[3],packet_bytearray[4],packet_bytearray[5])
        packet_info["ether_dst_addr"] = "{:x}.{:x}.{:x}.{:x}.{:x}.{:x}".format(packet_bytearray[6],packet_bytearray[7],packet_bytearray[8],packet_bytearray[9],packet_bytearray[10],packet_bytearray[11])
