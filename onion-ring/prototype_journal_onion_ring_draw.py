...
#    num_edgebox1 = f.read()
    ...
    textfont = {"size":15},
    labels=[" ","K-Fabric","K-Cube1","K-Cube2","K-Cube3","K-Cube4","K-Cube5","eno1","eno2","eno3","eno1  ","eno2  ","eno3  ","eno1 ","eno2 ","eno3 ","eno1   ","eno2   ","eno3   ","eno1    ","eno2    ","eno3    ","vSW1","vSW2","vSW3","VM1","VM2","VM3","vSW1 ","vSW2 ","vSW3 ","VM1 ","VM2 ","VM3 ","b1","a1","a2","a3","b2","b3","c1","c2","c3","c4","c5","c6","d1","d2","d3","d4","d5","d6","e1","e2","e3","e4","e5","e6","f1","f2","f3","f4","f5","f6","g1","g2","g3","g4","g5","g6","h1","h2","h3","h4","h5","h6","i1","i2","i3","i4","i5","i6","j1","j2","j3","j4","j5","j6","k1","k2","k3","k4","k5","k6","l1","l2","l3","l4","l5","l6","m1","m2","m3","m4","m5","m6",],#9
# all the settings below probably follows the order of the labels above

parents=[""," ","K-Fabric","K-Fabric","K-Fabric","K-Fabric","K-Fabric","K-Cube1","K-Cube1","K-Cube1","K-Cube2","K-Cube2","K-Cube2","K-Cube3","K-Cube3","K-Cube3","K-Cube4","K-Cube4","K-Cube4","K-Cube5","K-Cube5","K-Cube5","eno1    ","vSW1","vSW1","vSW3","vSW3","vSW2","eno1","vSW1 ","vSW1 ","vSW3 ","vSW3 ","vSW2 ","eno2","eno3","a1","a1","b1","b1","eno1  ","eno1  ","c1","c1","c2","c2","eno2  ","eno2  ","d1","d1","d2","d2","eno3  ","eno3  ","e1","e1","e2","e2","eno1 ","eno1 ","f1","f1","f2","f2","eno2 ","eno2 ","g1","g1","g2","g2","eno3 ","eno3 ","h1","h1","h2","h2","eno1   ","eno1   ","i1","i1","i2","i2","eno2   ","eno2   ","j1","j1","j2","j2","eno3   ","eno3   ","k1","k1","k2","k2","eno2    ","eno2    ","l1","l1","l2","l2","eno3    ","eno3    ","m1","m1","m2","m2",],
# values = [BPF2, BPF3, BPF1] : BFP1 size doesn't really change

marker = {"colors":[WHITE,WHITE,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GRAY,GREEN,GREEN,RED,RED,RED,RED,RED,RED],
        "line":{'color':[BLACK,BLACK,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,WHITE,]}}, # in the order of BPF2, BPF3
