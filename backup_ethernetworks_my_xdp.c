...
BPF_ARRAY(hash_test, unsigned char,2);
...
//    u64 in5 = 5;
    ...
    dummy_data0 = iph -> saddr;
    dummy_data1 = iph -> daddr;
    /*
     *
...
//    if ( (eth->h_dest[0] ==0) && (eth->h_dest[1] == 0) && (eth->h_dest[2] == 21) && (eth->h_dest[3] == 77) && (eth->h_dest[4] == 18) && (eth->h_dest[5] == 33))
//	    return XDP_DROP;
