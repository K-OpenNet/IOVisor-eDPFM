...
//	u32 test =  bpf_ktime_get_ns();	// return current time in nanoseconds
//	bpf_trace_printk("test = %d", test);
	...
	// drop if nextp is not IP_TCP nor IP_UDP nor IP_ICMP
	// TEST - START - 0402
